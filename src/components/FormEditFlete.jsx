        ...
        <div className="card is-shadowless has-background-light">
            <div className="card-content">
                ...
                <form method="post" action="/send/" enctype="multipart/form-data" onSubmit={updateFlete}>
                    ...
                    <div className="field">
                        <div className="control">
                        <button className="button is-success" type="sumbit" style={{ backgroundColor: "#183e6e", color: "white", marginRight: "10px" }}> Guardar cambios </button>
...
const FormEditFlete = () => {
    ...
    const [constInscripcionDGI_DOC, setConstInscripcionDGI_DOC] = useState('');
    const [constInscripcionBPS_DOC, setConstInscripcionBPS_DOC] = useState('');
    const [certDGI_DOC, setCertDGI_DOC] = useState('');
    const [certComunBPS_DOC, setCertComunBPS_DOC] = useState('');
    const [segAccidenteTrab_DOC, setSegAccidenteTrab_DOC] = useState('');
    const [planillaTrab_DOC, setPlanillaTrab_DOC] = useState('');
    const [certDGI_FECHAVENCIMIENTO, setCertDGI_FECHAVENCIMIENTO] = useState('');
    ...
    useEffect(() => {
        const getFleteById = async () => {
            try {
                ...
                setContactoTel(contactoTel);
                setRut(rut);
                setDireccion(direccion);
                setDepartamento(departamento);
                setCondicionContrato_DOC(condicionContrato_DOC);
                setConstInscripcionDGI_DOC(constInscripcionDGI_DOC);
                setConstInscripcionBPS_DOC(constInscripcionBPS_DOC);
                setCertDGI_DOC(certDGI_DOC);
                setCertComunBPS_DOC(certComunBPS_DOC);
                setSegAccidenteTrab_DOC(segAccidenteTrab_DOC);
                setPlanillaTrab_DOC(planillaTrab_DOC);
                setCertDGI_FECHAVENCIMIENTO(certDGI_FECHAVENCIMIENTO);
                setCertComunBPS_FECHAVENCIMIENTO(certComunBPS_FECHAVENCIMIENTO);
                setSegAccidenteTrab_FECHAVENCIMIENTO(segAccidenteTrab_FECHAVENCIMIENTO);
                setPlanillaTrab_FECHAEMISION(planillaTrab_FECHAEMISION);
            } catch (error) {
                if (error.response) {
                    setMsg(error.response.data.msg);
                }
    ...
    const updateFlete = async (e) => {
        ...
        try {
            ...
            setShowModal(true); // Mostrar el modal al guardar los cambios
        } catch (error) {
            if (error.response) {
                setMsg(error.response.data.msg);
            }
    ...
    return (
        <div>
            ...
            <div className="card is-shadowless has-background-light">
                <div className="card-content">
                    ...
                    <div className="field">
                        <label  className="label" style={{color:"black"}}> Documento certificado DGI </label>
                        <div className="control">
                            <input type="file" accept="application/pdf" className="input has-background-white has-text-black custom-input" value={certDGI_DOC} onChange={(e) => setCertDGI_DOC (e.target.value)} />
                        </div>
                        <label  className="label" style={{color:"black"}}> Fecha de vencimiento </label>
                        <div className="control">
                            <input type="date" className="input has-background-white has-text-black custom-input"  value={certDGI_FECHAVENCIMIENTO} onChange={(e) => setCertDGI_FECHAVENCIMIENTO (e.target.value)}/>
                    ...
                    <div className="field">
                        ...
                        <div className="control">
                            ...
                            <div className="field">
                                <div className="control">
                                    <button className="button is-success" type="submit" style={{ backgroundColor: "#183e6e", color: "white", marginRight: "10px" }}> Guardar cambios </button>
                                    <Link to='/fletes' className="button is-success" style={{ backgroundColor: "#183e6e", color: "white" }}> Cancelar </Link>
                                </div>
                            </div>
                        </form>
                        <VehiculosList />
            ...
            {/* Modal de Bulma para mostrar la alerta */}
